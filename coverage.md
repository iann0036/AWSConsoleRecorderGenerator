...
| *AWS::CloudFormation::CustomResource* | 0 |
| *AWS::CloudFormation::Stack* | 0 |
| *AWS::CloudFormation::WaitCondition* | 0 |
| *AWS::CloudFormation::WaitConditionHandle* | 0 |
...
| *dlm* | `DeleteLifecyclePolicy` | 0 |
| *dlm* | `GetLifecyclePolicies` | 0 |
...
| *ec2* | `ImportKeyPair` | 0 |
| *ec2* | `DescribeAvailabilityZones` | 1 |
| *ec2* | `RequestSpotInstances` | 0 |
| *ec2* | `DescribeSnapshots` | 0 |
...
| *ec2* | `DescribeVolumes` | 0 |
| *ec2* | `DeleteNetworkInterface` | 0 |
...
| *ec2* | `DescribeLaunchTemplateVersions` | 0 |
| *ec2* | `CreateRoute` | 0 |
...
| *mq* | `DescribeBroker` | 0 |
| *mq* | `UpdateBroker` | 0 |
| *mq* | `ListConfigurations` | 0 |
| *mq* | `UpdateConfiguration` | 0 |
| *mq* | `DescribeUser` | 0 |
| *mq* | `ListUsers` | 0 |
| *mq* | `DescribeConfiguration` | 0 |
| *mq* | `DescribeConfigurationRevision` | 0 |
| *mq* | `CreateUser` | 0 |
| *mq* | `CreateConfiguration` | 0 |
...
| *organizations* | `ListOrganizationalUnitsForParent` | 0 |
| *organizations* | `DescribeOrganizationalUnit` | 0 |
| *organizations* | `AcceptHandshake` | 0 |
| *organizations* | `DeleteOrganizationalUnit` | 0 |
| *organizations* | `DeletePolicy` | 0 |
...
| *organizations* | `DescribePolicy` | 0 |
| *organizations* | `ListCreateAccountStatus` | 0 |
| *organizations* | `CreateAccount` | 0 |
| *organizations* | `CancelHandshake` | 0 |
| *organizations* | `ListAccounts` | 0 |
| *organizations* | `AttachPolicy` | 0 |
| *organizations* | `MoveAccount` | 0 |
...
| *secretsmanager* | `CreateSecret` | 0 |
| *secretsmanager* | `DeleteSecret` | 0 |
...
| *serverlessrepo* | `CreateCloudFormationChangeSet` | 0 |
...
| *support* | `DescribeSeverityLevels` | 0 |
| *support* | `DescribeCases` | 0 |
...
| *support* | `DescribeCommunications` | 0 |
| *support* | `DescribeServices` | 0 |
...
| *xray* | `GetServiceGraph` | 0 |
| *xray* | `PutTelemetryRecords` | 0 |
| *xray* | `GetSamplingRules` | 0 |
| *xray* | `GetSamplingTargets` | 0 |
| *xray* | `GetTraceSummaries` | 0 |
| *xray* | `GetSamplingStatisticSummaries` | 0 |
| *xray* | `UpdateSamplingRule` | 0 |
| *xray* | `PutTraceSegments` | 0 |
| *xray* | `GetTraceGraph` | 0 |
| *xray* | `GetEncryptionConfig` | 0 |
| *xray* | `CreateSamplingRule` | 0 |
| *xray* | `BatchGetTraces` | 0 |
| *xray* | `PutEncryptionConfig` | 0 |
| *xray* | `DeleteSamplingRule` | 0 |
